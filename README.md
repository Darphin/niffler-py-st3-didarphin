...
- НЕУСПЕШНАЯ АВТОРИЗАЦИЯ - ЛОГИН
- НЕУСПЕШНАЯ АВТОРИЗАЦИЯ - ПАРОЛЬ
#### 2 СОЗДАНИЕ АККАУНТА
- РЕГИСТРАЦИЯ УСПЕШНАЯ
- РЕГИСТРАЦИЯ НЕКОРРЕКТНАЯ - ЛОГИН
- РЕГИСТРАЦИЯ НЕКОРРЕКТНАЯ - КОРОТКИЙ ПАРОЛЬ
- РЕГИСТРАЦИЯ НЕКОРРЕКТНАЯ - ДЛИННЫЙ ПАРОЛЬ
- РЕГИСТРАЦИЯ НЕКОРРЕКТНАЯ - ПАРОЛИ НЕ СООТВЕТВУЮТ
- РЕГИСТРАЦИЯ НЕКОРРЕКТНАЯ - АККАУНТ СУЩЕСТВУЕТ
#### 3 СОЗДАНИЕ СПЕНДИНГА
- НЕКОРРЕКТНЫЙ СПЕНДИНГ - БЕЗ СУММЫ
- НЕКОРРЕКТНЫЙ СПЕНДИНГ - БЕЗ КАТЕГОРИИ
- НЕКОРРЕКТНЫЙ СПЕНДИНГ - ДЛИННЫЙ ТЕКСТ
- НЕКОРРЕКТНЫЙ СПЕНДИНГ - БУДУЩАЯ ДАТА
- СОЗДАНИЕ СПЕНДИНГА
- РЕДАКТИРОВАНИЕ СПЕНДИНГА
- УДАЛЕНИЕ СПЕНДИНГА
#### 4. ИСТОРИЯ СПЕНДИНГОВ
- ПРОВЕРКА КАТЕГОРИЙ
- ПОИСК СПЕНДИНГА
- ФИЛЬТР ПО ДАТЕ
- ФИЛЬТР ПО ВАЛЮТЕ
...
#### 1. КАТЕГОРИИ
- +++ СОЗДАНИЕ КАТЕГОРИИ 
- СОЗДАНИЕ КАТЕГОРИИ С ТАКИМ ЖЕ ИМЕНЕМ ????
- +++ РЕДАКТИРОВАНИЕ КАТЕГОРИИ 
- +++ УДАЛЕНИЕ КАТЕГОРИИ
- +++ УДАЛЕНИЕ КАТЕГОРИИ У КОТОРОЙ ЕСТЬ СПЕНДИНГ
- +++ ОГРАНИЧЕНИЕ НА КОЛИЧЕСТВО КАТЕГОРИЙ
- СОЗДАНИЕ КАТЕГОРИИ - КОРОТКОЕ ИМЯ
- СОЗДАНИЕ КАТЕГОРИИ - ДЛИННОЕ ИМЯ
#### 2. СТАТИСТИКА
- getV2Statistic - РАЗНЫЕ ВАЛЮТЫ 
- getV2Statistic - ОДНА ВАЛЮТА
- getV2Statistic - ФИЛЬТР ДАТ
- getV2Statistic - НЕСКОЛЬКО КАТЕГОРИЙ
- getStatistic - РАЗНЫЕ ВАЛЮТЫ
- getStatistic - ОДНА ВАЛЮТА
- getStatistic - ФИЛЬТР ДАТ
- getStatistic - НЕСКОЛЬКО КАТЕГОРИЙ